...
kali:
	lxc image rm kali || true
	sudo distrobuilder build-lxd -o image.architecture=$(ARCH) -o image.release=kali-rolling -o image.variant=cloud -o source.url=https://kali.download/kali/ --import-into-lxd="kali" kali.yaml	
